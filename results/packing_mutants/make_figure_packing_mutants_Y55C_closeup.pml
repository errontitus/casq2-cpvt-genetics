...
hide everything
sele dimer_native_residues, \
    (resi 55) and dimer_native_polymer

hide labels
show cartoon, dimer_native_polymer
side_chain_helper("dimer_native_residues")
# show spheres, (yb_143_A or yb_280_B)

select view_center, dimer_native_residues and chain B

zoom view_center, 4
# rotate x, 90
# rotate x, 35
#turn x, -20
save_image_dimer("packing_mutants_Y55C_closeup")
